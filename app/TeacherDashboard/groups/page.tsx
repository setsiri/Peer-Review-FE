  ...
  return (
    <div className="p-6">
      ...
      <div className="flex justify-end mb-6">
        <button className="bg-[#1a1b26] text-[#7aa2f7] px-4 py-2 rounded-lg hover:bg-[#2a2e3b] transition-colors">
          สร้างกลุ่มใหม่
        </button>
      </div>
        ...
        {groups.map((group) => (
          <div key={group.id} className="bg-[#24283b] rounded-lg p-6">
            ...
            <div className="flex gap-2">
              ...
              <button className="flex-1 bg-[#1a1b26] text-[#f7768e] px-3 py-2 rounded-lg hover:bg-[#2a2e3b] transition-colors">
                ลบ
              </button>
            </div>
          </div>
