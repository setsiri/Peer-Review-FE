          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-8">
              <div className="flex items-center gap-3">
                <span className="text-[#a9b1d6] text-sm font-medium">Sort:</span>
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex gap-2 flex-wrap">
                  ...
                  {['ASSIGNED', 'SUBMITTED', 'READY_TO_REVIEW', 'IN_REVIEW', 'REVIEWED', 'COMPLETED'].map((status) => (
                    <button
                      key={status}
          ...
          <div className="divide-y divide-[#1a1b26]">
            {filteredAndSortedStudents.map((student) => (
              ...
              >
                ...
                <div className="flex items-center gap-3">
                  <span className={`px-3 py-1 rounded-full text-xs font-medium ${getStatusColor(student.status)} text-white`}>
                    {student.status}
                  </span>
                </div>
              </div>
